...
| agentgateway | Compatibility track | Phase 1 implementation | 1.5 policy schema; live matrix pending | OpenAI Chat Completions, Responses, Anthropic Messages | Buffered request/response mask, block, audit-only | Not yet claimed | Manual `AgentgatewayPolicy`; controller reconciliation pending |
